...
5. WHEN the user clicks "Open Deal Room", THE Telegram_Bot SHALL send the appropriate access link (creator or participant)
...
1. THE Telegram_Bot SHALL never log Creator_Link or Invite_Link URLs containing access tokens
