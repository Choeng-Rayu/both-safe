...
- [ ] 3. Implement core utility services and constants
  ...
  - [ ] 3.4 Create CurrentActor decorator for request context
    - Extract participant or admin from request object
    - Make available to controllers via @CurrentActor() decorator
    - _Requirements: 16_

- [ ] 4. Implement global exception handling and logging
  - [ ] 4.1 Create AllExceptionsFilter for consistent error responses
  ...
  - [ ] 4.2 Create domain-specific exception classes
...
- [ ] 10. Implement Ledger Module
  ...
  - [ ] 10.2 Create LedgerModule and export service
...
- [ ] 17. Implement Notification Module
  ...
  - [ ] 17.4 Create NotificationModule and export service
...
- [ ] 21. Implement deal expiration background job
  - [ ] 21.1 Create ExpirationService for deal expiration
  ...
  - [ ] 21.2 Schedule expiration job with @nestjs/schedule
    - Run every hour
    - _Requirements: 24_
...
- [ ] 29. Final integration and deployment preparation
  ...
  - [ ] 29.2 Run full test suite and verify coverage
    ...
    - Ensure 95% coverage for critical modules
    - _Requirements: All_
  
  - [ ] 29.3 Test with local PostgreSQL Docker container
