...
3. THE Backend_API SHALL store files in object storage (Supabase Storage or Cloudflare R2)
...
2. THE Backend_API SHALL read file storage credentials from environment variables
