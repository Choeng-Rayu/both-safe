...
export class UpdateProductDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(500) image_url?: string;
  @ApiPropertyOptional() @IsOptional() @IsInt() @Min(1) quantity?: number;
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(50) condition?: string;
...
export class UpdateParticipantDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() preferred_language?: 'km' | 'en' | 'zh';
}

export class UpdatePayoutDto {
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(500) payout_khqr?: string;
