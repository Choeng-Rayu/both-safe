...
- Name: smoke.spec.ts >> admin login opens deals dashboard
- Location: tests/e2e/smoke.spec.ts:70:5
...
Expected pattern: /\/admin\/deals/
Received string:  "http://localhost:3002/admin"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    14 × unexpected value "http://localhost:3002/admin"
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e22]:
      - generic [ref=e23]:
        - text: Admin access
        - heading "Admin access" [level=1] [ref=e24]
        - generic [ref=e25]:
          - generic [ref=e26]:
            - generic [ref=e27]:
              - text: Admin email
              - generic [ref=e28]: "*"
            - textbox "Admin email *" [ref=e29]: admin@bothsafe.local
          - generic [ref=e30]:
            - generic [ref=e31]:
              - text: Password
              - generic [ref=e32]: "*"
            - textbox "Password *" [ref=e33]: admin12345
          - paragraph [ref=e34]: Invalid admin credentials.
